<header class="banner <?php if(is_front_page()) echo 'fixed'; else echo 'fixed bg-white' ?> w-full py-6 xl:py-3">
  <div class="relative">
    <div class="container">
      <div class="logo-container flex justify-between items-center w-full">
        ...
        <nav class="nav-primary block lg:hidden mobile-nav">
